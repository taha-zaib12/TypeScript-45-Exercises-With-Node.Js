...
var guestList = ["Fatima", "Nirmal", "Abiha", "Ayan"];
//making variable for the guest who is not coming
var isNotComing = guestList[3];
...
guestList.forEach(function (finalGuests) { return console.log("Salam ".concat(finalGuests, ", would you like to come on dinner at my place")); });
...
while (guestList.length > 2) {
    var removedGuests = guestList.pop(); //using pop() function to remove guest one by one from end from array
...
guestList.forEach(function (twoGuests) { return console.log("".concat(twoGuests, ", you are still invited to dinner at my place")); });
