...
let countriesToVisit: string[] = ["Canada","Brazil","Autralia","France","Denmark"];

console.log("\n\tOriginal Order:", countriesToVisit);

console.log("\n\tAlphabetical Order:", [...countriesToVisit].sort());        //"[...]"is used to copy the array and .sort() will sort the array in aplhabeticalorder

console.log("\n\tStill in Original Order:", countriesToVisit);

console.log("\n\tReverse Order:", [...countriesToVisit].reverse()); //.reverse() is used to reverse the order
